...
fn to_value_i32() {
    ...
    assert_eq!(i32::to_dxr(&value), expected);
}
...
fn to_value_i64() {
    ...
    assert_eq!(i64::to_dxr(&value), expected);
}
...
fn to_value_boolean() {
    ...
    assert_eq!(bool::to_dxr(&value), expected);
}
...
fn to_value_string() {
    ...
    assert_eq!(String::to_dxr(&value), expected);
}
...
fn to_value_double() {
    ...
    assert_eq!(f64::to_dxr(&value), expected);
}
...
fn to_value_datetime() {
    ...
    assert_eq!(<DateTime<Utc>>::to_dxr(&value), expected);
}
...
fn to_value_base64() {
    ...
    assert_eq!(<Vec<u8>>::to_dxr(&value), expected);
}
...
fn to_value_struct_empty() {
    ...
    assert_eq!(Test::to_dxr(&value), expected);
}
...
fn to_value_array() {
    ...
    assert_eq!(<Vec<i32>>::to_dxr(&value), expected);
}
...
fn to_value_some() {
    ...
    assert_eq!(<Option<i32>>::to_dxr(&value), expected);
}
